...
class Assembler {
    ...
    // void compEntry(InstructionComp key,string val);
    // void destEntry(InstructionDest key,string val);
   ...
   public:
    ...
    map<InstructionComp,string>compdict;
    map<InstructionDest,string>destdict;
    map<InstructionJump,string>jumpdict;
    
    void compEntry(InstructionComp key,string val);
    void destEntry(InstructionDest key,string val);
    void jumpEntry(InstructionJump key,string val);
